      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-10 border-b border-slate-800">
          ...
          <div className="md:col-span-5 flex flex-col items-start">
            <a href="#" className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-cyan-500 via-sky-400 to-blue-600 p-0.5 shadow-md">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2.5 text-xs">
              <li>
                <a href="#privacy-policy" className="hover:text-cyan-400 transition-colors flex items-center gap-1.5">
                  <Shield className="w-3.5 h-3.5 text-cyan-400" />
                  Privacy Policy (Play Store)
                </a>
              </li>
              <li>
                <a href="#data-deletion" className="hover:text-cyan-400 transition-colors flex items-center gap-1.5">
                  <Trash2 className="w-3.5 h-3.5 text-rose-400" />
                  Account & Data Deletion
                </a>
              </li>
              <li>
                <a href="#support" className="hover:text-cyan-400 transition-colors flex items-center gap-1.5">
                  Support & Contact SLA
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <span>•</span>
            <a href="#data-deletion" className="hover:text-slate-300 transition-colors">Data Deletion</a>
            <span>•</span>
            <a href="#support" className="hover:text-slate-300 transition-colors">Support Contact</a>
          </div>
        </div>
